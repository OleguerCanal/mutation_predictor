...
from .attentions.attentions import RelativeMultiHeadAttention
...
class MultiHeadedSelfAttentionModule(nn.Module):
    r"""
    Transformers employ multi-headed self-attention (MHSA) while integrating an important technique from Transformer-XL,
